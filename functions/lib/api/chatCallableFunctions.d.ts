...
export declare const updateProjectGitHub: functions.HttpsFunction & functions.Runnable<any>;
export declare const sendMessage: functions.HttpsFunction & functions.Runnable<any>;
export declare const getRoadmap: functions.HttpsFunction & functions.Runnable<any>;
export declare const getAllProjects: functions.HttpsFunction & functions.Runnable<any>;
